...
│   ├── experiment-service/ # Java + Spring Boot (A/B实验服务)
│   ├── analytics-service/  # Java + Spring Boot (行为分析服务)
...
| search-service         | Java 25 | Spring Boot 4.0      | Elasticsearch              |
| recommendation-service | Java 25 | Spring Boot 4.0      | Milvus                     |
| ad-service             | Java 25 | Spring Boot 4.0      | PostgreSQL                 |
| experiment-service     | Java 25 | Spring Boot 4.0      | PostgreSQL (experiment_db) |
| analytics-service      | Java 25 | Spring Boot 4.0      | ClickHouse                 |
...
- PostgreSQL x4 (auth_db, user_db, blog_db, experiment_db)
- Redis
- Elasticsearch
- Kafka + Kafka UI（无 RabbitMQ）
- Milvus + MinIO + ClickHouse + OTel/Prometheus/Grafana
