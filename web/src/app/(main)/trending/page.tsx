...
const MOCK_TRENDING = [
  {
    ...
    likesCount: 456,
    viewsCount: 8920,
    author: { displayName: '前端观察者', username: 'frontend-observer' },
  },
  {
    id: '2',
    title: '从零到一搭建 CI/CD 流水线',
    likesCount: 342,
    viewsCount: 6780,
    author: { displayName: 'DevOps工程师', username: 'devops-eng' },
  },
  {
    id: '3',
    title: 'React vs Vue vs Svelte 对比评测',
    likesCount: 289,
    viewsCount: 5640,
  ...
  },
  {
    ...
    likesCount: 267,
    viewsCount: 5230,
    author: { displayName: 'Go专家', username: 'go-expert' },
  },
  {
    id: '5',
    ...
    likesCount: 234,
    viewsCount: 4560,
    author: { displayName: 'Docker布道师', username: 'docker-evangelist' },
  },
  {
    id: '6',
  ...
  },
  {
    ...
    likesCount: 198,
    viewsCount: 3890,
    author: { displayName: 'DBA小王', username: 'dba-wang' },
  },
  {
    id: '8',
    ...
    likesCount: 187,
    viewsCount: 3670,
    author: { displayName: 'Next.js爱好者', username: 'nextjs-fan' },
  },
  {
    id: '9',
    title: '微服务架构中的服务通信模式',
    likesCount: 176,
    viewsCount: 3450,
    author: { displayName: '架构师老李', username: 'architect-li' },
  },
  {
    id: '10',
    ...
    likesCount: 165,
    viewsCount: 3230,
    author: { displayName: 'CSS魔法师', username: 'css-magician' },
  },
];
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {posts.map((post: any, index: number) => (
            ...
            >
              <span
                className={`text-2xl font-bold w-8 text-center flex-shrink-0 ${
